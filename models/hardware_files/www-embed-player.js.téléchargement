...
return a}
var fc={Sa:"allow-forms",Ta:"allow-modals",Ua:"allow-orientation-lock",Va:"allow-pointer-lock",Wa:"allow-popups",Xa:"allow-popups-to-escape-sandbox",Ya:"allow-presentation",Za:"allow-same-origin",ab:"allow-scripts",bb:"allow-top-navigation",cb:"allow-top-navigation-by-user-activation"},hc=Eb(function(){return gc()});
...
for(var e=[],f=[],g=[],k=[128],l=1;64>l;++l)k[l]=0;var m,u;a();return{reset:a,update:c,digest:d,sa:function(){for(var a=d(),b="",c=0;c<a.length;c++)b+="0123456789ABCDEF".charAt(Math.floor(a[c]/16))+"0123456789ABCDEF".charAt(a[c]%16);return b}}}
...
function Gc(a){var b=Ec();b.update(a);return b.sa().toLowerCase()}
...
function Cd(a,b){if(0==a.b)if(a.g){var c=a.g;if(c.f){for(var d=0,e=null,f=null,g=c.f;g&&(g.g||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Cd(c,b):(f?(d=f,d.next==c.h&&(c.h=d),d.next=d.next.next):Dd(c),Ed(c,e,3,b)))}a.g=null}else ud(a,3,b)}
...
function Dd(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.h=null);return b}
M.prototype.m=function(){for(var a;a=Dd(this);)Ed(this,a,this.b,this.u);this.j=!1};
function Ed(a,b,c,d){if(3==c&&b.onRejected&&!b.g)for(;a&&a.i;a=a.g)a.i=!1;if(b.b)b.b.g=null,Kd(b,c,d);else try{b.g?b.f.call(b.context):Kd(b,c,d)}catch(e){Ld.call(null,e)}Jc(wd,b)}
...
Re[a.message]||0<=c.indexOf("/YouTubeCenter.js")||0<=c.indexOf("/mytube.js")))){b={Ra:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:e,level:b,"client.name":f.name},C:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);c&&(b.C.stack=c);for(var g in f)b.C["client."+g]=f[g];if(g=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var k in g)b.C[k]=g[k];Ge(Q("ECATCHER_REPORT_HOST","")+"/error_204",b);Re[a.message]=
!0;Se++}}
...
function lg(a,b){var c=cg[a],d=jg[a]||{};jg[a]=d;var e=Math.round(O());for(m in W[a]){var f=b.b;f={client:{hl:f.Aa,gl:f.za,clientName:f.ya,clientVersion:f.innertubeContextClientVersion}};var g=window.devicePixelRatio;g&&1!=g&&(f.client.screenDensityFloat=String(g));Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(f.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f={context:f};f[c]=ng(a,m);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=ig[m])a:{var k=
...
roundtripMs:bg}),ag=g,bg=0;og(b,a,f,{retry:eg.has(a),onSuccess:z(pg,this,O())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var m=d.diffCount||0;d.averageTimeBetweenDispatchesMs=m?(d.averageTimeBetweenDispatchesMs*m+c)/(m+1):c;d.diffCount=m+1}d.previousDispatchMs=e}
...
;function rg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.fb||Q("AUTHORIZATION"))||(a?b="Bearer "+w("gapi.auth.getToken")().eb:b=Hc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function zg(a){var b=this;this.b=a||{innertubeApiKey:ge("INNERTUBE_API_KEY"),innertubeApiVersion:ge("INNERTUBE_API_VERSION"),ya:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:ge("INNERTUBE_CONTEXT_CLIENT_VERSION"),Aa:ge("INNERTUBE_CONTEXT_HL"),za:ge("INNERTUBE_CONTEXT_GL"),Ba:ge("INNERTUBE_HOST_OVERRIDE")||"",Ca:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};vf(function(){yg(b)},0,5E3)}
...
n(Rg,L);Rg.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.hb)}L.prototype.l.call(this)};var Sg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Tg(a){a=a||"";if(window.spf){var b=a.match(Sg);spf.style.load(a,b?b[1]:"",void 0)}else Ug(a)}
...
;function Xg(a,b){L.call(this);this.j=this.T=a;this.D=b;this.m=!1;this.api={};this.P=this.B=null;this.G=new N;Zc(this,Ea($c,this.G));this.h={};this.N=this.R=this.g=this.X=this.b=null;this.H=!1;this.i=this.w=null;this.U={};this.na=["onReady"];this.W=null;this.fa=NaN;this.O={};Yg(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ea.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Fa.bind(this));this.V("onAdAnnounce",this.ra.bind(this));this.oa=new Rg(this);Zc(this,Ea($c,this.oa))}
...
h.Ia=function(a,b){if(!this.f){var c=Zg(this,b);c&&Md(this.G,a,c)}};
...
fb(a.O,String(d))};
return c}
h.ra=function(a){gf("a11y-announce",a)};
h.Ea=function(a){gf("WATCH_LATER_VIDEO_ADDED",a)};
h.Fa=function(a){gf("WATCH_LATER_VIDEO_REMOVED",a)};
h.wa=function(){return this.N||(ch(this)?"html5":null)};
h.va=function(){return this.W};
...
n(di,ci);function ei(){var a=this.f=new di(!!Q("WIDGET_ID_ENFORCE")),b=z(this.Ha,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
h=ei.prototype;h.Ha=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,fi(this,a)),this.i[a]=!0)):this.ma(a,b,c)};
h.ma=function(){};
function fi(a,b){return z(function(a){this.sendMessage(b,a)},a)}
h.addEventListener=function(){};
h.ta=function(){this.j=!0;this.sendMessage("initialDelivery",this.aa());this.sendMessage("onReady");F(this.h,this.la,this);this.h=[]};
...
h.dispose=function(){this.f=null};function hi(a){ei.call(this);this.b=a;this.g=[];this.addEventListener("onReady",z(this.Ga,this));this.addEventListener("onVideoProgress",z(this.Oa,this));this.addEventListener("onVolumeChange",z(this.Pa,this));this.addEventListener("onApiChange",z(this.Ja,this));this.addEventListener("onPlaybackQualityChange",z(this.La,this));this.addEventListener("onPlaybackRateChange",z(this.Ma,this));this.addEventListener("onStateChange",z(this.Na,this));this.addEventListener("onWebglSettingsChanged",z(this.Qa,
this))}
...
h.Ga=function(){var a=z(this.ta,this);this.f.b=a};
...
h.La=function(a){gi(this,{playbackQuality:a})};
h.Ma=function(a){gi(this,{playbackRate:a})};
h.Ja=function(){for(var a=this.b.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.b.getOptions(e);b[e]={options:f};for(var g=0,k=f.length;g<k;g++){var l=f[g],m=this.b.getOption(e,l);b[e][l]=m}}this.sendMessage("apiInfoDelivery",b)};
h.Pa=function(){gi(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
h.Oa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:A()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());gi(this,a)};
h.Qa=function(){var a={sphericalProperties:this.b.getSphericalProperties()};gi(this,a)};
...
;function yi(a){if("1"!==bb(he(),"args","privembed")){a&&ie();try{xi().then(function(a){a=le(a);a.bsq=zi++;Me("//www.youtube.com/ad_data_204",{xa:!1,C:a,withCredentials:!0})},function(){}),T(yi,18E5)}catch(b){R(b)}}}
